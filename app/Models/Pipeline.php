...
{
    use Auditable;
    protected $fillable = ['name', 'slug', 'description', 'business_unit_id', 'business_type', 'counts_as_custom_noo', 'is_active', 'created_by'];
    protected function casts(): array { return ['counts_as_custom_noo' => 'boolean', 'is_active' => 'boolean']; }

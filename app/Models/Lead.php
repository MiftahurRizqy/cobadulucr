...
class Lead extends Model
{
    ...
    protected $fillable = [
        ...
        'next_follow_up_at', 'last_activity_at', 'created_by',
    ];
    ...
    public function scopeVisibleTo(Builder $query, User $user): Builder
    {
        ...
        if ($user->authority_level === 'manager') return $query->whereIn('business_unit_id', $user->businessUnits()->pluck('business_units.id'));
